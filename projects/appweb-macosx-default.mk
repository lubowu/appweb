...
DEPS_38 += $(BUILD)/inc/psa/crypto.h
DEPS_38 += $(BUILD)/inc/mps_reader.h
DEPS_38 += $(BUILD)/inc/mps_trace.h
DEPS_38 += $(BUILD)/inc/ssl_tls13_keys.h
...
src/pcre/pcre.h: $(DEPS_44)

#
#   pcre.o
#
DEPS_45 += $(BUILD)/inc/me.h
DEPS_45 += src/pcre/pcre.h

$(BUILD)/obj/pcre.o: \
    src/pcre/pcre.c $(DEPS_45)
...
$(BUILD)/obj/proxyHandler.o: \
    src/modules/proxyHandler.c $(DEPS_46)
...
#   server.o
#
DEPS_48 += src/http/http.h

$(BUILD)/obj/server.o: \
    src/http/server.c $(DEPS_48)
...
DEPS_51 += $(BUILD)/inc/config.h
DEPS_51 += $(BUILD)/inc/windows.h
DEPS_51 += $(BUILD)/inc/sqlite3rtree.h

$(BUILD)/obj/sqlite3.o: \
    src/sqlite/sqlite3.c $(DEPS_51)
...
#   testHandler.o
#
DEPS_52 += src/appweb.h

$(BUILD)/obj/testHandler.o: \
    src/modules/testHandler.c $(DEPS_52)
...
$(BUILD)/obj/watchdog.o: \
    src/watchdog/watchdog.c $(DEPS_53)
...
$(BUILD)/bin/libmpr.dylib: $(DEPS_57)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 8.3 -current_version 8.3 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) 
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_59)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libhttp.dylib -compatibility_version 8.3 -current_version 8.3 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lpam 
endif

#
#   libmpr-version
#
DEPS_60 += $(BUILD)/inc/mpr-version.h
DEPS_60 += $(BUILD)/obj/mpr-version.o

$(BUILD)/bin/libmpr-version.a: $(DEPS_60)
...
DEPS_61 += $(BUILD)/bin/libmpr-version.a
ifeq ($(ME_COM_SQLITE),1)
...
$(BUILD)/bin/libesp.dylib: $(DEPS_61)
	@echo '      [Link] $(BUILD)/bin/libesp.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libesp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libesp.dylib -compatibility_version 8.3 -current_version 8.3 "$(BUILD)/obj/espLib.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) -lpam 
endif
...
DEPS_62 += $(BUILD)/inc/appweb.h
DEPS_62 += $(BUILD)/inc/customize.h
DEPS_62 += $(BUILD)/obj/config.o
DEPS_62 += $(BUILD)/obj/convenience.o
DEPS_62 += $(BUILD)/obj/cgiHandler.o
DEPS_62 += $(BUILD)/obj/espHandler.o
DEPS_62 += $(BUILD)/obj/fastHandler.o
DEPS_62 += $(BUILD)/obj/proxyHandler.o
DEPS_62 += $(BUILD)/obj/testHandler.o
DEPS_62 += $(BUILD)/obj/rom.o
...
#   espcmd
#
DEPS_65 += $(BUILD)/bin/libesp.dylib
ifeq ($(ME_COM_SQLITE),1)
    DEPS_65 += $(BUILD)/bin/libsql.dylib
endif
DEPS_65 += $(BUILD)/obj/esp.o
...
$(BUILD)/bin/appweb-esp: $(DEPS_65)
	@echo '      [Link] $(BUILD)/bin/appweb-esp'
	$(CC) -o $(BUILD)/bin/appweb-esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/esp.o" $(LIBPATHS_65) $(LIBS_65) $(LIBS_65) $(LIBS) -lpam 
endif
...
#   extras
#
DEPS_66 += src/esp/esp-compile.json
DEPS_66 += src/esp/vcvars.bat

$(BUILD)/.extras-modified: $(DEPS_66)
	@echo '      [Copy] $(BUILD)/bin'
	mkdir -p "$(BUILD)/bin"
...
#   httpcmd
#
DEPS_67 += $(BUILD)/bin/libhttp.dylib
...
$(BUILD)/bin/http: $(DEPS_67)
	...
	$(CC) -o $(BUILD)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/http.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) -lpam 
endif
...
#   install-certs
#
DEPS_69 += src/certs/samples/ca.crt
DEPS_69 += src/certs/samples/ca.key
DEPS_69 += src/certs/samples/ec.crt
DEPS_69 += src/certs/samples/ec.key
DEPS_69 += src/certs/samples/roots.crt
DEPS_69 += src/certs/samples/self.crt
DEPS_69 += src/certs/samples/self.key
DEPS_69 += src/certs/samples/test.crt
DEPS_69 += src/certs/samples/test.key

$(BUILD)/.install-certs-modified: $(DEPS_69)
	@echo '      [Copy] $(BUILD)/bin'
	mkdir -p "$(BUILD)/bin"
